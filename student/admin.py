...
from .models import Student, CompletedSubject
...
class StudentAdmin(ModelAdmin,ImportExportModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('first_name', 'middle_name', 'last_name', 'dob', 'email', 'unique_username', 'phone_number', 'temporary_address', 'permanent_address')
        }),
        ('Timestamps', {
